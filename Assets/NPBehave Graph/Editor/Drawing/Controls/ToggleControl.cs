...
namespace UnityEditor.BehaveGraph.Drawing.Controls 
{
    ...
    class ToggleControlView : VisualElement
    {
        ...
        public ToggleControlView(string label, AbstractBehaveNode node, PropertyInfo propertyInfo)
        {
            m_Node = node;
            m_PropertyInfo = propertyInfo;
            styleSheets.Add(Resources.Load<StyleSheet>("Styles/NPControls/ToggleControlView"));
            ...
            m_Toggle = new Toggle();
            m_Toggle.RegisterValueChangedCallback(OnChangeToggle);
