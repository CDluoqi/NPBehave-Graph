...
namespace UnityEditor.BehaveGraph.Serialization
{
    static class MultiJsonInternal
    {
        public class UnknownJsonObject : JsonObject
        {
            ...
            public override T CastTo<T>()
            {
                ...
                Type t = typeof(T);
                if (t == typeof(AbstractBehaveNode) || t.IsSubclassOf(typeof(AbstractBehaveNode)))
                {
        ...
        internal class UnknownNPBehaveSlotType : NPBehaveSlot
        {
            ...
            {
                [SerializeField]
                public SlotType m_SlotType = SlotType.InputSlot;
        ...
        internal class UnknownNodeType : AbstractBehaveNode
        {
            public string jsonData;
